      ...
      <div className="max-w-full mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8 xl:col-span-1">
            ...
            <p className="text-neutral-500 dark:text-neutral-400 text-base">
              Empowering education through seamless connections and
              ...
              <div>
                ...
                <ul className="mt-4 space-y-4">
                  <li>
                    <a
                      href="#"
                      className="text-base text-neutral-500 hover:text-neutral-900 dark:text-neutral-400 dark:hover:text-white"
                    >
                      Student Portal
                    </a>
                  </li>
        ...
        <div className="mt-12 border-t border-neutral-200 dark:border-neutral-700 pt-8">
          <p className="text-base text-neutral-400 xl:text-center">
            &copy; 2023 EduConnect, Inc. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
